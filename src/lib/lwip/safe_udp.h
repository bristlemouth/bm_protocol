...
inline err_t safe_udp_sendto(struct udp_pcb *pcb, struct pbuf *p,
...
inline err_t safe_udp_sendto_if(struct udp_pcb *pcb, struct pbuf *p,
...
inline err_t safe_udp_sendto_if_src(struct udp_pcb *pcb, struct pbuf *p,
