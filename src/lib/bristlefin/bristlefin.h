...
#define BF_LED_OFF (1)
  ...
  typedef enum { LED_OFF = 0, LED_GREEN, LED_RED, LED_YELLOW } led_state_e;
...
public:
  Bristlefin(MS5803 &ms5803, HTU21D &htu21d, Bme280 &bme280,
             TCA::TCA9546A &tca_mux, INA::INA232 &ina232);
  bool sensorsInit();
  void setGpioDefault();
