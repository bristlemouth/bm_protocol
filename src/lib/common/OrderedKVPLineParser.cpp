...
OrderedKVPLineParser::OrderedKVPLineParser(const char* separator, size_t maxLineLen, ValueType* valueTypes,
                                           size_t numValues, const char** keys, const char* header /*= nullptr*/)
