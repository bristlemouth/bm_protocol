...
#define timeRemainingMs(startTimeMs, timeoutMs) pdTICKS_TO_MS(timeRemainingGeneric(pdMS_TO_TICKS(startTimeMs), xTaskGetTickCount(), pdMS_TO_TICKS(timeoutMs)))
#define timeRemainingMsFromISR(startTimeMs, timeoutMs) pdTICKS_TO_MS(timeRemainingGeneric(pdMS_TO_TICKS(startTimeMs), xTaskGetTickCountFromISR(), pdMS_TO_TICKS(timeoutMs)))
