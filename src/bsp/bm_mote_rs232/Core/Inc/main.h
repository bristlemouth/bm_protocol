...
#define TP18_Pin LL_GPIO_PIN_1
#define TP18_GPIO_Port GPIOA
...
#define PL_BUCK_EN_Pin LL_GPIO_PIN_4
#define PL_BUCK_EN_GPIO_Port GPIOA
#define TP9_Pin LL_GPIO_PIN_5
#define TP9_GPIO_Port GPIOA
#define TP4_Pin LL_GPIO_PIN_6
#define TP4_GPIO_Port GPIOA
#define TP6_Pin LL_GPIO_PIN_7
