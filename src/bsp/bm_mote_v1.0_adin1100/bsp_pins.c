...
IOPinHandle_t ADIN1100_MDC      = {&STM32PinDriver, &(STM32Pin_t){ADIN1100_MDC_GPIO_Port, ADIN1100_MDC_Pin, NULL, NULL}};
IOPinHandle_t ADIN1100_MDIO     = {&STM32PinDriver, &(STM32Pin_t){ADIN1100_MDIO_GPIO_Port, ADIN1100_MDIO_Pin, NULL, NULL}};
IOPinHandle_t ADIN1100_INT_N    = {&STM32PinDriver, &(STM32Pin_t){ADIN1100_INT_N_GPIO_Port, ADIN1100_INT_N_Pin, NULL, NULL}};
