...
/* Private defines -----------------------------------------------------------*/
#define ADIN1100_MDC_Pin          LL_GPIO_PIN_2
#define ADIN1100_MDC_GPIO_Port    GPIOA
#define ADIN1100_MDIO_Pin         LL_GPIO_PIN_3
#define ADIN1100_MDIO_GPIO_Port   GPIOA
#define ADIN1100_INT_N_Pin        LL_GPIO_PIN_0
#define ADIN1100_INT_N_GPIO_Port  GPIOH
#define ADIN1100_INT_N_EXTI_IRQn  EXTI0_IRQn
