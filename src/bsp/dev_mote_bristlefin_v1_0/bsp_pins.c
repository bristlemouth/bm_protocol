...
IOPinHandle_t EXP_GPIO5 = {&PCA9535PinDriver, &(PCA9535Pin_t){&devMoteIOExpander, 10, PCA9535_MODE_OUTPUT}};
IOPinHandle_t EXP_GPIO6 = {&PCA9535PinDriver, &(PCA9535Pin_t){&devMoteIOExpander, 11, PCA9535_MODE_OUTPUT}};
IOPinHandle_t EXP_GPIO7 = {&PCA9535PinDriver, &(PCA9535Pin_t){&devMoteIOExpander, 12, PCA9535_MODE_OUTPUT}};
IOPinHandle_t EXP_GPIO8 = {&PCA9535PinDriver, &(PCA9535Pin_t){&devMoteIOExpander, 13, PCA9535_MODE_OUTPUT}};
IOPinHandle_t EXP_GPIO9 = {&PCA9535PinDriver, &(PCA9535Pin_t){&devMoteIOExpander, 14, PCA9535_MODE_OUTPUT}};
IOPinHandle_t EXP_GPIO10 = {&PCA9535PinDriver, &(PCA9535Pin_t){&devMoteIOExpander, 15, PCA9535_MODE_OUTPUT}};
IOPinHandle_t EXP_GPIO11 = {&PCA9535PinDriver, &(PCA9535Pin_t){&devMoteIOExpander, 16, PCA9535_MODE_OUTPUT}};
IOPinHandle_t EXP_GPIO12 = {&PCA9535PinDriver, &(PCA9535Pin_t){&devMoteIOExpander, 17, PCA9535_MODE_OUTPUT}};
IOPinHandle_t EXP_INT = {&PCA9535PinDriver, &(PCA9535Pin_t){&devMoteIOExpander, 22, PCA9535_MODE_OUTPUT}};
...
IOPinHandle_t BF_EXP_IMU_INT = {&PCA9535PinDriver, &(PCA9535Pin_t){&bristlefinIOExpander, 5, PCA9535_MODE_OUTPUT}};
IOPinHandle_t BF_EXP_IMU_RST = {&PCA9535PinDriver, &(PCA9535Pin_t){&bristlefinIOExpander, 6, PCA9535_MODE_OUTPUT}};
IOPinHandle_t BF_EXP_SDI12_OE = {&PCA9535PinDriver, &(PCA9535Pin_t){&bristlefinIOExpander, 7, PCA9535_MODE_OUTPUT}};
IOPinHandle_t BF_EXP_TP16 = {&PCA9535PinDriver, &(PCA9535Pin_t){&bristlefinIOExpander, 10, PCA9535_MODE_OUTPUT}};
IOPinHandle_t BF_EXP_LED_G1 = {&PCA9535PinDriver, &(PCA9535Pin_t){&bristlefinIOExpander, 11, PCA9535_MODE_OUTPUT}};
IOPinHandle_t BF_EXP_LED_R1 = {&PCA9535PinDriver, &(PCA9535Pin_t){&bristlefinIOExpander, 12, PCA9535_MODE_OUTPUT}};
IOPinHandle_t BF_EXP_LED_G2 = {&PCA9535PinDriver, &(PCA9535Pin_t){&bristlefinIOExpander, 13, PCA9535_MODE_OUTPUT}};
IOPinHandle_t BF_EXP_LED_R2 = {&PCA9535PinDriver, &(PCA9535Pin_t){&bristlefinIOExpander, 14, PCA9535_MODE_OUTPUT}};
