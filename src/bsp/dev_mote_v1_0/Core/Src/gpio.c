...
void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_EXTI_SetEXTISource(LL_EXTI_EXTI_PORTH, LL_EXTI_EXTI_LINE3);
  ...
  /**/
  LL_GPIO_SetPinPull(BOOT_LED_GPIO_Port, BOOT_LED_Pin, LL_GPIO_PULL_NO);

  /**/
  LL_GPIO_SetPinPull(ADIN_INT_GPIO_Port, ADIN_INT_Pin, LL_GPIO_PULL_NO);

  /**/
  LL_GPIO_SetPinMode(BOOT_LED_GPIO_Port, BOOT_LED_Pin, LL_GPIO_MODE_INPUT);
